...
| Icons | Lucide React |
| Weather Data | [Weather AI API](https://api.weather-ai.co) |
...
- A **Weather AI API key** — [see below](#getting-a-weather-ai-api-key)
...
4. Paste it into your `.env.local` file as shown in [step 3](#3-configure-environment-variables).
